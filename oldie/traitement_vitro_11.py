...
print("plot UH")
test_m_exp.plot_UH_windowed(traj1,nbit,fit,10,95,1,legend)
test_m_exp.plot_UH_norm_windowed(traj1,nbit,fit,10,95,1,legend)
print("plot BB")
test_m_exp.plot_BB_windowed(traj1,nbit,fit,10,90,1,legend)
print("plot H")
test_m_exp.plot_H_windowed(traj1,nbit,fit,10,98,1,legend)
